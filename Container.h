//шаблонный класс Container с итератором, в основе двусвязный список
//
//преимущества: 
//		все методы, кроме clear() и reverse(), за O(1)
//недостатки: 
//		метод end() возвращает итератор, указывающий на последний элемент - не всегда удобно
